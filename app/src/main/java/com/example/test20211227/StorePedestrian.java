...
public class StorePedestrian extends AppCompatActivity implements TMapGpsManager.onLocationChangedCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.storepedestrian_activity);
    ...
    public void onLocationChange(Location location) {
        ...
        tmapdata.findAroundNamePOI(tMapPoint1, "편의점", 7, 99,
