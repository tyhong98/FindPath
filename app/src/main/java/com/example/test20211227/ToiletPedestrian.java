...
public class ToiletPedestrian extends AppCompatActivity implements TMapGpsManager.onLocationChangedCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.toiletpedestrian_activity);
    ...
    public void onLocationChange(Location location) {
        ...
        tmapdata.findAroundNamePOI(tMapPoint1, "화장실", 10, 99,
    ...
    private int nRightButtonCount = 1;
