...
public class ToiletCar extends AppCompatActivity implements TMapGpsManager.onLocationChangedCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.toiletcar_activity);
    ...
    public void onLocationChange(Location location) {
        ...
        tmapdata.findAroundNamePOI(tMapPoint1, "화장실", 10, 50,
