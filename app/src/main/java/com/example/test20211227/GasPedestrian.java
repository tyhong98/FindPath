...
public class GasPedestrian extends AppCompatActivity implements TMapGpsManager.onLocationChangedCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gaspedestrian_activity);
    ...
    public void onLocationChange(Location location) {
        ...
        tmapdata.findAroundNamePOI(tMapPoint1, "주유소", 7, 99,
