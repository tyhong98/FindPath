...
public class GasCar extends AppCompatActivity implements TMapGpsManager.onLocationChangedCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gascar_activity);
    ...
    public void onLocationChange(Location location) {
        ...
        tmapdata.findAroundNamePOI(tMapPoint1, "주유소", 3, 99,
